...
function load_table() {
    var table = $('#konsumen').DataTable({
        ...
        "ajax": {
            url: base_url + 'MasterKonsumen/load_data',
        },
        "columns": [
            {"data": "no"},
            {"data": "nama_konsumen"},
